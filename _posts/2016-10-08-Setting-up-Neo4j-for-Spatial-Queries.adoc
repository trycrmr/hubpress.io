...
1. Now that we have a map layer consisting of the world's countries we can find what country a point resides in. To make our Cypher more intuitive add a "Country" label to all nodes referencing the RTREE:
