...
--4. Validate you can perform a query that calculates the distance between two location nodes. 
...
The query will provide the distance in kilometers between two locations which are in the same country:
